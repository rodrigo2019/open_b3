...
from tensorflow.keras.layers import Dense, Input, BatchNormalization, Flatten, Conv1D
...
if __name__ == "__main__":
    ...
    data_dict, class_weights = load_data("dataset", le)
    print(class_weights)
    set_memory_growth()
